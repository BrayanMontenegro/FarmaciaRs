...
public class JInternalFrame_venta extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setBorder(javax.swing.BorderFactory.createTitledBorder("ID Venta"));
        jTextField1.setOpaque(false);

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jComboBox1.setBorder(javax.swing.BorderFactory.createTitledBorder("ID Cliente"));
        jComboBox1.setOpaque(false);

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jComboBox2.setBorder(javax.swing.BorderFactory.createTitledBorder("ID Empleado"));
        jComboBox2.setOpaque(false);

        jTextField2.setText("jTextField2");
        jTextField2.setBorder(javax.swing.BorderFactory.createTitledBorder("Fecha Hora"));
